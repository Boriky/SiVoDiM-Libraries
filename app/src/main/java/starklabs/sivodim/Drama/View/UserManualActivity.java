...
public class UserManualActivity extends AppCompatActivity implements UserManualInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userManual.setText(Html.fromHtml("\n" +
                ...
                "Sintesi Vocale per Dispositivi Mobili. Il documento è disponibile direttamente dal drawerG\n" +
                ...
                "vocale FA-TTSG, realizzato dall’azienda MIVOQ s.r.l. e messo a disposizione del team di\n" +
                "sviluppo Stark Labs. Il team rende disponibili due applicazioni per sistemi AndroidG:</p>\n" +
                "<ul>\n" +
                ...
                "con sistema operativo AndroidG 4.0 o superiore.</p>\n" +
                ...
                "<ol>\n" +
                "<li>Scaricare l’apkG dalla pagina ufficiale del team di sviluppo;</li>\n" +
                "<li>Salvare l’apk nella memoria SDG del dispositivo;</li>\n" +
                ...
                "USBG al dispositivo e disporre di un gestore file per navigare nella cartella\n" +
                "in cui è stata copiata.</li></ul></li>\n" +
                "<li>Seguire la procedura guidata di AndroidG per completare il processo di installazione.</li></ol>\n" +
                "\n" +
                ...
                "drawerG. Dal drawer è possibile accedere all’applicazione di configurazione SiVoDiM,\n" +
                ...
                "strumenti è possibile esportare rapidamente lo sceneggiato in formato MP3G e condividerlo\n" +
                ...
                "<li>Esporta in video: esporta lo sceneggiato in locale nel formato MP4G (video);</li>\n" +
                ...
                "<ul>\n" +
                "<li>Modifica capitolo: abilita la modifica di titolo, soundtrackG e immagine di sfondo;</li>\n" +
                "<li>Lista personaggi: accesso alla lista completa di tutti i personaggi appartenenti allo\n" +
                "sceneggiato aperto.</li></ul>\n" +
                ...
                "dello schermo.</li></ol>\n" +
                "<p>A questo punto lo sceneggiato è disponibile nella homeG.\n" +
                ...
                "(a) Navigare fra i file presenti nella memoria SDG e selezionare la traccia audio\n" +
                "desiderata (formati supportati: MP3G e WAVG).</li>\n" +
                ...
                "desiderata (formati supportati: JPGG e PNGG).</li>\n" +
                "<li>Confermare la creazione premendo l’apposita icona posta nell’angolo in alto a destra\n" +
                "dello schermo.</li></ol>\n" +
                ...
                "<li>Caricare un avatarG dalla memoria SDG del dispositivo:\n" +
                ...
                "<p>Dalla homeG dell’applicazione effettuare una pressione prolungata sullo sceneggiato che si\n" +
                ...
                "<p>Dalla schermata interna a uno sceneggiato accedere al menu a tendina posto nell’angolo in\n" +
                "alto a destra dello schermo:</p><ol>\n" +
                "<li>Selezione di una delle due opzioni di esportazione: audio (MP3G) o video (MP4G).</li>\n" +
                ...
                "presente il pulsante di accesso al drawerG. Dal drawer è possibile accedere al manuale\n" +
                ...
                "<li>Modificare i parametri designati negli sliderG per ottenere una voce personalizzata:<ul>\n" +
